...
var catalog = []Game{
	...
	{ID: "hlds-cs", Name: "Counter-Strike 1.6 (HLDS)", Source: "steam", SteamAppID: 90, Summary: "Classic Half-Life dedicated server running CS 1.6 (~250MB). Smallest Source A2S-queryable Steam server, used as our CI Steam fixture.", DefaultPort: 27015, Protocols: []string{"udp"}},
